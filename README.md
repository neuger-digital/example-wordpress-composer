...
* Run `terminus build:project:create --team='Neuger Communications Group' --org="neuger-digital" --ci="circleci" --git="github" --visibility="private" neuger-digital/example-wordpress-composer site-name`
